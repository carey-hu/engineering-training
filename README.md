...
2. **跟路线**：打开 [00 学习路线](教程文档/00_learning_path.md)，从第 1 步往下走，每个实验先看目标、再上代码、最后对「完成标志」。
3. **卡住了**：先看本页底部的 [安全须知](#安全须知必读) 和各教程末尾的「常见错误」。
...
| 2 | 让板载 LED 闪烁，验证上传流程 | [学习路线](教程文档/00_learning_path.md) | [01_LED闪烁](示例代码/01_LED闪烁/01_blink_onboard_led.ino) |
...
| 04 | [WiFi 网页控制 LED](示例代码/04_WiFi网页控制LED/04_wifi_web_led.ino) | 手机连 ESP32 热点，用网页控制 LED |
...
高级示例的单独说明：[06](示例代码/06_电机基础控制/README.md) ・ [07](示例代码/07_电机速度模式/README.md) ・ [08](示例代码/08_电机位置模式/README.md) ・ [09](示例代码/09_电机网页控制/README.md) ・ [10](示例代码/10_机器人整合控制/README.md)
...
> [!NOTE]
> 部分 ESP32-S3-WROOM 模组会占用 GPIO35/36/37 作为内部 flash/PSRAM 通信，外部不可用。本教程默认使用的 GPIO2、10、11、12、13、16、17、18 已按课程资料核对。
...
| 3D 模型 | [电机](硬件资料/3D模型/电机/MG4010-i10电机.STEP) ・ [舵机](硬件资料/3D模型/舵机/MG90S舵机主体.STEP) ・ 舵盘 [单](硬件资料/3D模型/舵机/单向舵盘.STEP)/[双](硬件资料/3D模型/舵机/双向舵盘.STEP)/[四](硬件资料/3D模型/舵机/四向舵盘.STEP) |
...
教师审阅与维护见 [10 审阅报告](教程文档/10_review_report.md)。
