...
│   ├── 06_电机基础控制/           # MG4010 电机基础（使能/失能/状态）
│   ├── 07_电机速度模式/           # MG4010 闭环速度控制
│   ├── 08_电机位置模式/           # MG4010 闭环位置控制
...
授课教师请提前准备离线资源包（放 U 盘或传到课程群），省去课上下载等待：
...
**新手建议**：先把 01-05 跑通，电机例程（06-09）需要 MG4010 电机硬件。
