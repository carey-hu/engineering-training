...
2. 电机 ID 是否为 1
3. RS485 A/B 是否接反
4. ESP32、RS485/供电转接板或 RS485 模块、电机电源负极是否共地
5. 使用转接板时，GPIO17(TX) 是否接 TTL-485 调试口 T，GPIO18(RX) 是否接 R，GND 是否共地
6. 使用通用 RS485 模块时，DE/RE 是否接到 GPIO16，并且两个引脚已连在一起
7. RS485 模块是否支持 ESP32 的 3.3V 逻辑
8. 电机是否已经独立供电
```
